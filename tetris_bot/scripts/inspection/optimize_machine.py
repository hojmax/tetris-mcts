...
class ScriptArgs:
    ...
    output_json: Path = BENCHMARKS_DIR / "profiles" / "optimize_latest.json"
    output_env: Path = BENCHMARKS_DIR / "profiles" / "optimize_latest.env"
...
def write_latest_outputs(*, output_json: Path, output_env: Path, payload: dict) -> None:
    ...
    env_lines = [
        ...
        f"TETRIS_OPT_MACHINE_FINGERPRINT={payload['machine_fingerprint']}",
        f"TETRIS_OPT_MODEL_PATH={payload['model_path']}",
...
def main(args: ScriptArgs) -> None:
    ...
    print(f"  latest_json={args.output_json}")
    print(f"  latest_env={args.output_env}")
