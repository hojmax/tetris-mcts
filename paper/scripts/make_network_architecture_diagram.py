...
def draw_architecture(ax: Axes) -> None:
    ...
    draw_volume_block(
        ...
        BlockSpec(
            ...
            title="Conv Stem",
            subtitle="32 × 20 × 10  (CoordConv: 1→3 ch)",
        ),
        palette,
    )
    ...
    draw_box(
        ...
        BoxSpec(
            ...
            subtitle="Linear(1632 → 512 → 256) + LN + SiLU\ncached board embedding",
            title_size=10.2,
            subtitle_size=7.75,
        ),
        palette,
    ...
    draw_box(
        ...
        BoxSpec(
            ...
            edge_color=palette.note_edge,
            title="Concat",
            subtitle="board_h (256) ++ aux_h (128)",
            title_size=10.0,
            subtitle_size=7.7,
        ),
        palette,
    ...
    draw_box(
        ...
        BoxSpec(
            ...
            edge_color=palette.fusion_edge,
            title="Fusion MLP",
            subtitle="Linear(384 → 256) + LayerNorm + SiLU\n1× Residual block (256 → 256 → 256)",
            title_size=10.2,
            subtitle_size=7.55,
        ),
        palette,
    ...
    draw_box(
        ...
        BoxSpec(
            ...
            edge_color=palette.fusion_edge,
            title="Aux Encoder",
            subtitle="Linear(61 → 128) + LayerNorm + SiLU\nLinear(128 → 128) + LayerNorm + SiLU",
            title_size=10.1,
            subtitle_size=7.55,
        ),
        palette,
